...
func TestServiceCollector(t *testing.T) {
	...
	`
	cases := []generateMetricsTestCase{{Obj: &v1.Service{ObjectMeta: metav1.ObjectMeta{Name: "test-service1", CreationTimestamp: metav1.Time{Time: time.Unix(1500000000, 0)}, Namespace: "default", Labels: map[string]string{"app": "example1"}}, Spec: v1.ServiceSpec{ClusterIP: "1.2.3.4", Type: v1.ServiceTypeClusterIP}}, Want: `
...
`, MetricNames: []string{"kube_service_created", "kube_service_info", "kube_service_labels", "kube_service_spec_type"}}, {Obj: &v1.Service{ObjectMeta: metav1.ObjectMeta{Name: "test-service2", CreationTimestamp: metav1.Time{Time: time.Unix(1500000000, 0)}, Namespace: "default", Labels: map[string]string{"app": "example2"}}, Spec: v1.ServiceSpec{ClusterIP: "1.2.3.5", Type: v1.ServiceTypeNodePort}}, Want: `
...
`}, {Obj: &v1.Service{ObjectMeta: metav1.ObjectMeta{Name: "test-service3", CreationTimestamp: metav1.Time{Time: time.Unix(1500000000, 0)}, Namespace: "default", Labels: map[string]string{"app": "example3"}}, Spec: v1.ServiceSpec{ClusterIP: "1.2.3.6", LoadBalancerIP: "1.2.3.7", Type: v1.ServiceTypeLoadBalancer}}, Want: `
...
`}, {Obj: &v1.Service{ObjectMeta: metav1.ObjectMeta{Name: "test-service4", CreationTimestamp: metav1.Time{Time: time.Unix(1500000000, 0)}, Namespace: "default", Labels: map[string]string{"app": "example4"}}, Spec: v1.ServiceSpec{ExternalName: "www.example.com", Type: v1.ServiceTypeExternalName}}, Want: `
			...
			`}, {Obj: &v1.Service{ObjectMeta: metav1.ObjectMeta{Name: "test-service5", CreationTimestamp: metav1.Time{Time: time.Unix(1500000000, 0)}, Namespace: "default", Labels: map[string]string{"app": "example5"}}, Spec: v1.ServiceSpec{Type: v1.ServiceTypeLoadBalancer}, Status: v1.ServiceStatus{LoadBalancer: v1.LoadBalancerStatus{Ingress: []v1.LoadBalancerIngress{v1.LoadBalancerIngress{IP: "1.2.3.8", Hostname: "www.example.com"}}}}}, Want: `
			...
			`}, {Obj: &v1.Service{ObjectMeta: metav1.ObjectMeta{Name: "test-service6", CreationTimestamp: metav1.Time{Time: time.Unix(1500000000, 0)}, Namespace: "default", Labels: map[string]string{"app": "example6"}}, Spec: v1.ServiceSpec{Type: v1.ServiceTypeClusterIP, ExternalIPs: []string{"1.2.3.9", "1.2.3.10"}}}, Want: `
