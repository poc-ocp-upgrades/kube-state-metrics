...
func TestPersistentVolumeCollector(t *testing.T) {
	...
	`
	cases := []generateMetricsTestCase{{Obj: &v1.PersistentVolume{ObjectMeta: metav1.ObjectMeta{Name: "test-pv-pending"}, Status: v1.PersistentVolumeStatus{Phase: v1.VolumePending}}, Want: `
...
`, MetricNames: []string{"kube_persistentvolume_status_phase"}}, {Obj: &v1.PersistentVolume{ObjectMeta: metav1.ObjectMeta{Name: "test-pv-available"}, Status: v1.PersistentVolumeStatus{Phase: v1.VolumeAvailable}}, Want: `
...
`, MetricNames: []string{"kube_persistentvolume_status_phase"}}, {Obj: &v1.PersistentVolume{ObjectMeta: metav1.ObjectMeta{Name: "test-pv-bound"}, Status: v1.PersistentVolumeStatus{Phase: v1.VolumeBound}}, Want: `
...
`, MetricNames: []string{"kube_persistentvolume_status_phase"}}, {Obj: &v1.PersistentVolume{ObjectMeta: metav1.ObjectMeta{Name: "test-pv-released"}, Status: v1.PersistentVolumeStatus{Phase: v1.VolumeReleased}}, Want: `
...
`, MetricNames: []string{"kube_persistentvolume_status_phase"}}, {Obj: &v1.PersistentVolume{ObjectMeta: metav1.ObjectMeta{Name: "test-pv-failed"}, Status: v1.PersistentVolumeStatus{Phase: v1.VolumeFailed}}, Want: `
...
`, MetricNames: []string{"kube_persistentvolume_status_phase"}}, {Obj: &v1.PersistentVolume{ObjectMeta: metav1.ObjectMeta{Name: "test-pv-pending"}, Status: v1.PersistentVolumeStatus{Phase: v1.VolumePending}, Spec: v1.PersistentVolumeSpec{StorageClassName: "test"}}, Want: `
				kube_persistentvolume_status_phase{persistentvolume="test-pv-pending",phase="Available"} 0
					kube_persistentvolume_status_phase{persistentvolume="test-pv-pending",phase="Bound"} 0
					kube_persistentvolume_status_phase{persistentvolume="test-pv-pending",phase="Failed"} 0
					kube_persistentvolume_status_phase{persistentvolume="test-pv-pending",phase="Pending"} 1
...
`, MetricNames: []string{"kube_persistentvolume_status_phase"}}, {Obj: &v1.PersistentVolume{ObjectMeta: metav1.ObjectMeta{Name: "test-pv-available"}, Status: v1.PersistentVolumeStatus{Phase: v1.VolumeAvailable}}, Want: `
				...
				`, MetricNames: []string{"kube_persistentvolume_info"}}, {Obj: &v1.PersistentVolume{ObjectMeta: metav1.ObjectMeta{Name: "test-labeled-pv", Labels: map[string]string{"app": "mysql-server"}}, Status: v1.PersistentVolumeStatus{Phase: v1.VolumePending}, Spec: v1.PersistentVolumeSpec{StorageClassName: "test"}}, Want: `
					kube_persistentvolume_labels{label_app="mysql-server",persistentvolume="test-labeled-pv"} 1
				`, MetricNames: []string{"kube_persistentvolume_labels"}}, {Obj: &v1.PersistentVolume{ObjectMeta: metav1.ObjectMeta{Name: "test-unlabeled-pv"}, Status: v1.PersistentVolumeStatus{Phase: v1.VolumeAvailable}}, Want: `
