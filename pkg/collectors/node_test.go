...
func TestNodeCollector(t *testing.T) {
	...
	`
	cases := []generateMetricsTestCase{{Obj: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "127.0.0.1"}, Status: v1.NodeStatus{NodeInfo: v1.NodeSystemInfo{KernelVersion: "kernel", KubeletVersion: "kubelet", KubeProxyVersion: "kubeproxy", OSImage: "osimage", ContainerRuntimeVersion: "rkt"}}, Spec: v1.NodeSpec{ProviderID: "provider://i-uniqueid"}}, Want: `
        ...
        kube_node_status_capacity{node="127.0.0.1",resource="storage",unit="byte"} 3e+09
			`}, {Obj: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "127.0.0.1"}, Status: v1.NodeStatus{Phase: v1.NodeRunning}}, Want: `
...
`, MetricNames: []string{"kube_node_status_phase"}}, {Obj: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "127.0.0.2"}, Status: v1.NodeStatus{Phase: v1.NodePending}}, Want: `
...
`, MetricNames: []string{"kube_node_status_phase"}}, {Obj: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "127.0.0.3"}, Status: v1.NodeStatus{Phase: v1.NodeTerminated}}, Want: `
...
`, MetricNames: []string{"kube_node_status_phase"}}, {Obj: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "127.0.0.1"}, Status: v1.NodeStatus{Conditions: []v1.NodeCondition{{Type: v1.NodeNetworkUnavailable, Status: v1.ConditionTrue}, {Type: v1.NodeReady, Status: v1.ConditionTrue}, {Type: v1.NodeConditionType("CustomizedType"), Status: v1.ConditionTrue}}}}, Want: `
...
`, MetricNames: []string{"kube_node_status_condition"}}, {Obj: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "127.0.0.2"}, Status: v1.NodeStatus{Conditions: []v1.NodeCondition{{Type: v1.NodeNetworkUnavailable, Status: v1.ConditionUnknown}, {Type: v1.NodeReady, Status: v1.ConditionUnknown}, {Type: v1.NodeConditionType("CustomizedType"), Status: v1.ConditionUnknown}}}}, Want: `
...
`, MetricNames: []string{"kube_node_status_condition"}}, {Obj: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "127.0.0.3"}, Status: v1.NodeStatus{Conditions: []v1.NodeCondition{{Type: v1.NodeNetworkUnavailable, Status: v1.ConditionFalse}, {Type: v1.NodeReady, Status: v1.ConditionFalse}, {Type: v1.NodeConditionType("CustomizedType"), Status: v1.ConditionFalse}}}}, Want: `
      kube_node_status_condition{condition="CustomizedType",node="127.0.0.3",status="false"} 1
        ...
        kube_node_status_condition{condition="Ready",node="127.0.0.3",status="unknown"} 0
			`, MetricNames: []string{"kube_node_status_condition"}}, {Obj: &v1.Node{ObjectMeta: metav1.ObjectMeta{Name: "127.0.0.1"}, Spec: v1.NodeSpec{Taints: []v1.Taint{{Key: "node.kubernetes.io/memory-pressure", Value: "true", Effect: v1.TaintEffectPreferNoSchedule}, {Key: "Accelerated", Value: "gpu", Effect: v1.TaintEffectPreferNoSchedule}, {Key: "Dedicated", Effect: v1.TaintEffectPreferNoSchedule}}}}, Want: `
	...
	for i, c := range cases {
		c.Func = composeMetricGenFuncs(nodeMetricFamilies)
