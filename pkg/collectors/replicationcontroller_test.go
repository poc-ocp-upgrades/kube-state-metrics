...
`}, {Obj: &v1.ReplicationController{ObjectMeta: metav1.ObjectMeta{Name: "rc2", Namespace: "ns2", Generation: 14}, Status: v1.ReplicationControllerStatus{Replicas: 0, FullyLabeledReplicas: 5, ReadyReplicas: 0, AvailableReplicas: 0, ObservedGeneration: 5}, Spec: v1.ReplicationControllerSpec{Replicas: &rc2Replicas}}, Want: `
