...
`}, {Obj: &v1beta1.ReplicaSet{ObjectMeta: metav1.ObjectMeta{Name: "rs2", Namespace: "ns2", Generation: 14}, Status: v1beta1.ReplicaSetStatus{Replicas: 0, FullyLabeledReplicas: 5, ReadyReplicas: 0, ObservedGeneration: 5}, Spec: v1beta1.ReplicaSetSpec{Replicas: &rs2Replicas}}, Want: `
